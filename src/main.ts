...
import { faAlignJustify, faArrowLeft, faArrowRight, faBullseye, 
  faCalendar, faCamera, faCaretDown, faCaretLeft, faCaretRight, faClone, faExclamationTriangle,
...
library.add(faAlignJustify, faArrowLeft, faArrowRight, faBullseye, 
  faCalendar, faCamera, faCaretDown, faCaretLeft, faCaretRight, faClone,
